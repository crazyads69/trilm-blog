...
//   return (
//     <header className="w-full flex items-center justify-center border-b bg-background/95 backdrop-blur supports-backdrop-blur:bg-background/60">
//       <div className="container flex h-16 items-center justify-around py-4">
//         {/* Logo */}
//         <div className="flex items-center gap-2 flex-shrink-0 hover:cursor-pointer group">
...
//               width={120}
//               height={80}
//               className="transition-all duration-300 ease-in-out transform group-hover:scale-105"
//             />
//           </Link>
//         </div>
